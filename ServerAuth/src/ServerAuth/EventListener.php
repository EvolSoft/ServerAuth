...
class EventListener implements Listener {
	...
	public function onPreLogin(PlayerPreLoginEvent $event){
		...
		if($cfg['force-single-auth']){
			...
			if($count > 1){
				$event->setKickMessage($this->plugin->translateColors("&", ServerAuth::getAPI()->getConfigLanguage()->getAll()["single-auth"]), $this->plugin->translateColors("&", ServerAuth::getAPI()->getConfigLanguage()->getAll()["single-auth"]), false);
